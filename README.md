...
libraryDependencies += "com.github.pocketberserker" %% "dog" % "0.2.0" % "test"
```

```scala
libraryDependencies += "com.github.pocketberserker" %% "dog-gen" % "0.2.0" % "test"
```

```scala
libraryDependencies += "com.github.pocketberserker" %% "dog-props" % "0.2.0" % "test"
```
